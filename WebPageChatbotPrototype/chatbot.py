...
el_words = pickle.load(open('el_words.pkl', 'rb'))
el_classes = pickle.load(open('el_classes.pkl', 'rb'))
el_model = load_model('el_chatbotmodel.h5')
loc_words = pickle.load(open('loc_words.pkl', 'rb'))
loc_classes = pickle.load(open('loc_classes.pkl', 'rb'))
loc_model = load_model('loc_chatbotmodel.h5')
...
def predict_loc_class(sentence):
...
while True:
    ...
    ints = predict_el_class(re.sub('<[^>]+>', '', message))
